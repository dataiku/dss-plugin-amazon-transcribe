    ...
    def test_start_transcription_job_exception(self, stubber):
        ...
        with pytest.raises(amazon_transcribe_api_client.APITranscriptionJobError):
            response = self.api_wrapper.start_transcription_job(language="auto",
                                                                ...
                                                                input_folder_bucket="jplassmann-transcribe-plugin",
                                                                input_folder_root_path="dataiku/DKU_TUTORIAL_BASICS_101/IDGRZLFi",
                                                                output_folder_bucket="jplassmann-transcribe-plugin",
                                                                output_folder_root_path="dataiku/DKU_TUTORIAL_BASICS_101/IDGRZLFi",
                                                                job_id="job_name")
